 ...
 */
yup.addMethod<yup.StringSchema>(yup.string, "iranNationalId", function (errorMessage) {
 ...
 * it is OPTIONAL validation! if you want to require it use `required` after this validation.
 */
yup.addMethod<yup.StringSchema>(yup.string, "iranMobile", function (errorMessage) {
 ...
 * it is OPTIONAL validation! if you want to require it use `required` after this validation.
 */
yup.addMethod<yup.StringSchema>(yup.string, "iranBankCard", function (errorMessage) {
 ...
 * it is OPTIONAL validation! if you want to require it use `required` after this validation.
 */
yup.addMethod<yup.StringSchema>(yup.string, "iranShebaNumber", function (errorMessage) {
 ...
 * it is OPTIONAL validation! if you want to require it use `required` after this validation.
 */
yup.addMethod<yup.StringSchema>(yup.string, "iranPostalCode", function (errorMessage) {
 ...
 * it is OPTIONAL validation! if you want to require it use `required` after this validation.
 */
yup.addMethod<yup.StringSchema>(yup.string, "ipAddress", function (errorMessage) {
