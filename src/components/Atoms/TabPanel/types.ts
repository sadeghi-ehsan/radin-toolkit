...
export type IToolsTabPanel = IToolWithIcon | IToolWithTitle;
...
export type ITabPaneProps = ITabPaneWithIcon | ITabPaneWithTitle;
...
export interface ITabPanelProps extends Omit<StandardProps, "children"> {
  ...
  children?: Array<{ props?: ITabPaneProps; key?: string }> | ReactNode;
