...
export type ProgressBarSizes = keyof typeof progressBarSizes;

export type ProgressBarColors = keyof typeof progressBarColors;

export type ProgressBarShapes = keyof typeof progressBarShapes;

export type ProgressBarDirections = keyof typeof progressBarDirections;
