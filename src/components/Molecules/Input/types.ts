...
export type OmitBaseInputProps = "fontSize" | "type" | "maxLength" | "size";

export interface IInputProps
  extends Omit<IFormElWrapperProps, "onClear" | "onFieldsetClick">,
    Omit<IBaseInputProps, OmitBaseInputProps> {
