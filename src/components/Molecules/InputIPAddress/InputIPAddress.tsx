...
import { IInputIPAddressProps } from "./types";
...
export const InputIPAddress = forwardRef<HTMLInputElement, IInputIPAddressProps>(
  (
    {
      // Input props
      className,
    ...
    const normalizedValue = `${combinedValue.part1}${combinedValue.part2 && `.${combinedValue.part2}`}${
      combinedValue.part3 && `.${combinedValue.part3}`
    }${combinedValue.part4 && `.${combinedValue.part4}`}`;
    ...
    return (
      <FormElementWrapper
        ...
        startAdornment={startAdornment || <Ip size="xl" color={disabled ? "disabled" : "idle"} />}
      >
...
) as CompoundedComponent<IInputIPAddressProps>;
