...
export declare type IInputMultiplierOptions = Array<{ label: string; value: string }>;
export declare type IInputMultiplierValue = { value: string; selectedOption: string };
