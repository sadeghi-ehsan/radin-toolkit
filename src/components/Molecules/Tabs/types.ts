...
export type INotice = false | "private" | "public";
...
export interface ITabsProps extends StandardProps {
  ...
  // children?: Array<{ props?: ITabsPaneProps; key?: string }> | ReactNode;
...
export interface ITabTitle extends ITabsProps {
  ...
  child: { props?: ITabsPaneProps; key?: string };
  ...
  setData: Dispatch<SetStateAction<Array<{ props?: ITabsPaneProps; key?: string }>>>;
