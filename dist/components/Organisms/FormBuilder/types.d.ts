...
export declare type TFormBuilderFormMethod = "new" | "update" | "readOnly";
export declare type TFormBuilderUseFormReturn = UseFormReturn;
export declare type TUseFormBuilder = (args?: {
    formOptions?: UseFormProps;
}) => TUseFormBuilderReturn;
export declare type TUseFormBuilderReturn = {
    formProps: TFormBuilderUseFormReturn;
    setValidationSchemaObj: (schema: any) => void;
};
export declare type IFormBuilderCustomComponentProps = {
    formProps: TFormBuilderUseFormReturn;
    field?: any;
...
export declare type TFormBuilderReturningParams = {
    formProps: TFormBuilderUseFormReturn;
    formMethod?: TFormBuilderFormMethod;
};
export declare type IFormBuilderFieldWrapperProps = (args: {
    fieldSchema: TFormBuilderSchemaTypes;
    formProps: TFormBuilderUseFormReturn;
    returningParams: TFormBuilderReturningParams;
...
interface ComponentSchemaType<ComponentTypeName, ComponentType> {
    ...
    props: ComponentType | ((args: TFormBuilderReturningParams) => ComponentType);
    ...
    fields?: TFormBuilderSchemaTypes[];
    name?: string;
}
export declare type TFormBuilderSchemaTypes = ComponentSchemaType<null, any> | ComponentSchemaType<"space", any> | ComponentSchemaType<"Button", IButtonProps> | ComponentSchemaType<"Input", IInputProps> | ComponentSchemaType<"InputBankCard", IInputBankCardProps> | ComponentSchemaType<"InputCascading", IInputCascadingProps> | ComponentSchemaType<"InputCodeVerify", IInputCodeVerifyProps> | ComponentSchemaType<"InputImageUploader", IInputImageUploaderProps> | ComponentSchemaType<"InputIPAddress", IInputIPAddressProps> | ComponentSchemaType<"InputMultipleInputs", IInputMultipleInputsProps> | ComponentSchemaType<"InputMultiplier", IInputMultiplierProps> | ComponentSchemaType<"InputPassword", IInputPasswordProps> | ComponentSchemaType<"InputSheba", IInputShebaProps> | ComponentSchemaType<"InputNumber", IInputNumberProps> | ComponentSchemaType<"Select", ISelectProps> | ComponentSchemaType<"Slider", ISliderProps> | ComponentSchemaType<"FieldGroup", IFieldGroupProps> | ComponentSchemaType<"Textarea", ITextareaProps> | ComponentSchemaType<"DatePicker", IDatePickerProps>;
export declare type TFormBuilderFieldTypes = "space" | "Button" | "Input" | "InputSheba" | "InputBankCard" | "InputCascading" | "InputCodeVerify" | "InputImageUploader" | "InputIPAddress" | "InputMultipleInputs" | "InputMultiplier" | "InputPassword" | "InputNumber" | "Select" | "Slider" | "FieldGroup" | "Textarea" | "DatePicker";
export {};
