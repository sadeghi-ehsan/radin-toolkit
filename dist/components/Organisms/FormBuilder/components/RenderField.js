...
export default function RenderField({ fieldSchema, formMethod, modifyValidationSchema, returningParams }) {
    ...
    return _jsx("div", { className: classJoin(["w-full sm:px-2", widthMap[width], className]), children: fieldComponent });
}
