...
export const InputMultipleInputs = forwardRef(({ 
// Input props
className, clearedValue, 
// FormElementWrapper props,
size, clearable, 
// BaseInput props
id: _id, onChange, disabled, readOnly, value, name: filedName, style, startAdornment, placeholder, schema, direction, align, ...restProps }, passedRef) => {
    ...
    const [combinedValue, setCombinedValue] = useState(undefined);
    useEffect(() => {
    ...
    return (_jsx(FormElementWrapper, { ...wrapperProps, ...{
            ...
            direction === "rtl" ? "dir-rtl" : "dir-ltr"
        ]), children: _jsx("div", { ref: inputsContainerRef, children: schema?.map((input, index) => (_jsx("div", { className: classJoin([
                    ...
                    input.rootClassName || ""
                ]), children: _jsx(BaseInput, { name: input.name, id: `${id}-part${index}`, value: combinedValue?.[input?.name] || "", type: input.type || "text", align: input.align || align, onChange: handleChange, disabled: disabled, readOnly: readOnly, fontSize: size === "sm" ? "xs" : "sm", className: classJoin([
...
//# sourceMappingURL=InputMultipleInputs.js.map