...
export interface IInputTimeProps extends Omit<IInputNumberProps, "align" | "value" | "variant" | "legendVariant" | "fieldsetVariant" | "size" | "label" | "clearedValue" | "clearable" | "allowClear" | "endLabelAdornment" | "noEndDivider" | "block" | "min" | "max" | "baseInputClassName" | "negativesInRed" | "positivesInGreen" | "counterType" | "onChange"> {
