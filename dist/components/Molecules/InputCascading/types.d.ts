...
export declare type IInputCascadingOptions = Array<{
    label: string;
    value: string;
}>;
export declare type IInputCascadingTypeInputValue = {
    value: string;
    selectedOption: string;
};
export declare type IInputCascadingTypeSelectValue = {
    value: any;
    selectedOption: string;
};
...
export declare type IInputCascadingProps = IInputCascadingTypeInputProps | IInputCascadingTypeSelectProps;
export {};
