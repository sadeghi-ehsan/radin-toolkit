...
export declare type RadioSize = keyof typeof radioSizes;
export declare type RadioColor = keyof typeof radioColors;
export declare type RadioVariant = keyof typeof radioVariants;
