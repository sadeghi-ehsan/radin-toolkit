...
export declare type BadgeSizes = keyof typeof badgeSizes;
/** The Badge's color attribute. This is set to "primary" by default */
export declare type BadgeColors = keyof typeof badgeColors;
/** The Badge's type attribute. This is set to "tag" by default */
export declare type BadgeTypes = keyof typeof badgeTypes;
...
export declare type IBadgeProps = BadgeTypeBadgeProps | TagTypeBadgeProps | StateTypeBadgeProps;
