...
export declare type ITypographyFontWeightType = keyof typeof fontWeights;
export declare type ITypographyTextVariantType = keyof typeof textVariants;
export declare type ITypographyTagType = "div" | "span" | "li" | "pre" | "p" | "label";
