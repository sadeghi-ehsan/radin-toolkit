...
/** adornment types */
export declare type AdornmentType = ReactNode;
...
export declare type WrapperVariant = keyof typeof wrapperVariants;
export declare type WrapperSize = keyof ReturnType<typeof wrapperSizes>;
export declare const formElWrapperProps: string[];
