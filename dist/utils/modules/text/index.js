import numbersMapping from "../utf8-codes/numberMapping";
import { persianToEnglishNumber } from "../numbers";
import { removeSpaces } from "../spaces";
import persianMapping from "../utf8-codes/persianMapping";
/**
 *
 * @param text String
 * @returns {String}
...
const normalizePersianText = (text) => {
    ...
    normalized = normalized
        ...
        .split("")
        .map(function (c) {
        const mapped = persianMapping[c.charCodeAt(0)];
...
const createSearchField = (text) => {
    ...
    normalized = normalized
        ...
        .split("")
        .map(function (c) {
        const mapped = persianMapping[c.charCodeAt(0)] || numbersMapping[c.charCodeAt(0)] || isEnglishCharacter(c);
