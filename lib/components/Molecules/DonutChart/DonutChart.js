...
var _excluded = ["className", "data", "options", "centerText", "condition"];
...
var DonutChart = function DonutChart(_ref) {
  ...
  var renderInitialOptions = function renderInitialOptions() {
    return {
      ...
      title: {
        text: (0, _utils2.charTitle)(hoveredItem, centerText, condition),
        useHTML: true,
        y: 39
      },
      legend: {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
    className: (0, _utils.classJoin)(["sbt-DonutChart mx-auto", className]),
